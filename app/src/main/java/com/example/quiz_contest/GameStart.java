...
public class GameStart extends Activity {
	...
	String q[]={
			"မြန်မာနိုင်ငံလွတ်လပ်ရေးရပြီးနောက် ပထမဆုံးသမ္မတမှာ",
			"နေအဖွဲ့အစည်းမှာ အကြီးဆုံးဂြိုလ်က ဘယ်ဂြိုလ်လဲ။",
	...
	String a[]={"ဒေါက်တာဘဦး","ပလူတို","yatch","Plant","Zero","Continuous","October","WWE","4","Length","6","Ear","Asia","Earring","1857","Argentina","Autumn","Red"
	...
	String b[]={"မန်းဝင်းမောင်","ဂျူပီတာ","racecar","Sporting Event","Two","Irregular","November","TEZ","1","Millimeter","7","Stomach","Australia","Glass Slipper",
	...
	String c[]={"စဝ်ရွှေသိုက်","စေတန်","train","Sea Creature","One","Repetitive","January","OWO","3","Yard","8","Head","Europe","Ring","1867","Brazil","Summer",
	...
	String d[]={"ဦးနေဝင်း","မာကျူရီ","car","River","Three","Consistent","September","TWO","2","Meter","4","Foot","Africa","Purse","1861","Russia","Winter",
